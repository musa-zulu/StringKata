...
namespace PlayerStringKata
{
    public class TestStringCalculator : ITestPack<IStringCalculator>
    {
        ...
        [Test] public void Given_LargeSingleNumberInputStringShould_ReturnSingleNumber()
        {
        ...
        [Test]
        public void Given_ManyNumbersInputStringWithNewLineInBetweenShould_ReturnSum()
        {
            const string input = "1\n2,3";
            const int expected = 6;
            var calculator = CreateSUT();
        ...
        [Test]
        public void Given_NumbersInputStringWithCustormDelimiterInBetweenShould_ReturnSum()
        {
            const string input = "//;\n1;2";
            const int expected = 3;
            var calculator = CreateSUT();
        ...
        [Test]
        public void Given_NumbersInputStringWithNegativeNumberShould_ThrowException()
        {
            const string input = "-1";
        ...
        [Test]
        public void Given_NumbersInputStringWithAnotherNegativeNumberShould_ThrowException()
        {
        ...
        [Test]
        public void Given_NumbersInputStringWithNegativeNumbersShould_ThrowException()
        {
            const string input = "-1,-2";
        ...
        [Test]
        public void Given_NumbersInputStringWithDelimitersOfAnyLengthInBetweenShould_ReturnSum()
        {
            const string input = "//[***]\n1***2***3";
            const int expected = 6;
            var calculator = CreateSUT();
        ...
        [Test]
        public void Given_NumbersInputStringWithMultipleDelimitersInBetweenShould_ReturnSum()
        {
            const string input = "//[*][%]\n1*2%3";
            const int expected = 6;
            var calculator = CreateSUT();
        ...
        [Test]
        public void Given_NumbersInputStringWithMultipleDelimitersOfAnyLengthuInBetweenShould_ReturnSum()
        {
            const string input = "//[*][%][&]\n1*2%3&4";
