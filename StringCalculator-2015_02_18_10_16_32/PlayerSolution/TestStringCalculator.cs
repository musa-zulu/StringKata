...
namespace PlayerStringKata
{
    public class TestStringCalculator : ITestPack<IStringCalculator>
    {
        ...
        [Test]
        public void Given_TwoNumberstringInputShould_ReturnSum()
        {
        ...
        [Test]
        public void Given_ManyNumberstringInputShould_ReturnSum()
        {
        ...
        [Test]
        public void Given_NumberStringInputWithNewLineInBetweenShould_ReturnSum()
        {
            const string input = "1\n2,3";
            const int expected = 6;
            var calculator = CreateCalculator();
        ...
        [Test]
        public void Given_NumberStringInputWithSingleCustormDelimiterShould_ReturnSum()
        {
            const string input = "//;\n1;2";
            const int expected = 3;
            var calculator = CreateCalculator();
        ...
        [Test]
        public void Given_NumberStringInputWithSingleNegativeNumberShould_ThrowException()
        {
            const string input = "-1";
        ...
        [Test]
        public void Given_NumberStringInputWithManyNegativeNumbersShould_ThrowException()
        {
            const string input = "-1,-2";
        ...
        [Test]
        public void Given_NumberStringInputWithValueGreaterThanThousandShould_ReturnSum()
        {
        ...
        [Test]
        public void Given_NumberStringInputWithValueNotGreaterThanThousandShould_ReturnSum()
        {
        ...
        [Test]
        public void Given_NumberStringInputWithDelimitersOfAnyLengthShould_ReturnSum()
        {
            const string input = "//[***]\n1***2***3";
            const int expected = 6;
            var calculator = CreateCalculator();
        ...
        [Test]
        public void Given_NumberStringInputWithMultipleDelimitersShould_ReturnSum()
        {
            const string input = "//[*][%]\n1*2%3";
            const int expected = 6;
            var calculator = CreateCalculator();
        ...
        [Test]
        public void Given_NumberStringInputWithMultipleDelimitersOfAnyLengthShould_ReturnSum()
        {
            const string input = "//[*][%][^]\n1*2%3^4";
